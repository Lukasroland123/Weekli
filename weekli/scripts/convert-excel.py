...
Kør fra projektets rod: python billige-retter/scripts/convert-excel.py

Kilde:  C:/Users/Lukas/Desktop/Opdateret produktdatabase/
Output: billige-retter/src/data/products.json
"""
...
EXCEL_DIR = Path(r"C:\Users\Lukas\Desktop\Opdateret produktdatabase")
